...
class GFNetPyramid(nn.Module):
    def __init__(self, in_chans=320, img_size=224, patch_size=4, embed_dim=[128], depth=[2],
                 mlp_ratio=[4],
