...
########original padding
    ...
    # print(" x.size(0) * x.size(2) * x.size(3)", x.size(0), x.size(2), x.size(3))
    ...
    with open(csvfile, 'a+') as f:
        row = [imgpath[-1], bpp * num_pixels, num_pixels, bpp, y_bpp, z_bpp,
               ...
               ms_ssim(x, out_dec["x_hat"], data_range=1.0).item(), enc_time, dec_time, 0 * 1000,
...
def main(args):
    ...
    if 0:
        ...
        input_data = torch.randn(1, 3, 640, 640).to('cuda')
